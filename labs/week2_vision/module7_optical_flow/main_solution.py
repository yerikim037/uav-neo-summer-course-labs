...
Week 2 · Module 7 — Optical Flow (SOLUTION) — Main orchestrator

Runs every step in sequence against the simulator:
    drone sim module7_optical_flow/main_solution.py
...
neo_lab.run_module("Week 2 · Module 7 — Optical Flow (SOLUTION)", [
