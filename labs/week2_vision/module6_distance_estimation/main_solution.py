...
Week 2 · Module 6 — Distance Estimation (SOLUTION) — Main orchestrator

Runs every step in sequence against the simulator:
    drone sim module6_distance_estimation/main_solution.py
...
neo_lab.run_module("Week 2 · Module 6 — Distance Estimation (SOLUTION)", [
